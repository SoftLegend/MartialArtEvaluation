...
class Ui_Main(object):
    def setupUi(self, Main):
        ...
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(0, 0, 301, 211))
        ...
        self.lblDuration_5.setPixmap(QtGui.QPixmap(_fromUtf8("icons/clock.png")))
        ...
        self.txtName = QtGui.QLineEdit(self.verticalLayoutWidget)
