...
class Ui_Monitor(object):
    def setupUi(self, Monitor):
        ...
        self.btnResult = QtGui.QPushButton(self.verticalLayoutWidget)
        self.btnResult.setObjectName(_fromUtf8("btnResult"))
        self.horizontalLayout_5.addWidget(self.btnResult)
        ...
        self.label.setGeometry(QtCore.QRect(20, 80, 311, 171))
    ...
    def retranslateUi(self, Monitor):
        ...
        self.btnResult.setText(_translate("Monitor", "Result", None))
